...
#ifndef ADC_DIVIDER
#  define ADC_DIVIDER 2 // following the comparison between the previous value and the current one +- the threshold the value will be published or not
#endif
/*-------------------PIN DEFINITIONS----------------------*/
#if defined(ESP8266) || !defined(ADC_GPIO)
#  define ADC_GPIO A0 //on nodeMCU this is D3 pin
#endif
#if defined(ESP32) || !defined(ADC_GPIO)
#  define ADC_GPIO 33 //on ESP32 this is 35 pin
#endif
#endif
