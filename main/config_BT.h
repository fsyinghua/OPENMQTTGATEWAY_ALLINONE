...
#  define Scan_duration 60000 //define the time for a scan
#endif
#ifndef BLEScanInterval
#  define BLEScanInterval 10000 // How often the scan occurs / switches channels; in milliseconds,
#endif
#ifndef BLEScanWindow
#  define BLEScanWindow 3000 // How long to scan during the interval; in milliseconds.
#endif
...
#  define ScanBeforeConnect 1000 //define number of scans before connecting to BLE devices (ESP32 only, minimum 1)
#endif
